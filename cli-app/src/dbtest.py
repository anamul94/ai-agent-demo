...
def get_engine(db_file: str = DB_PATH) -> Engine:
...
def read_all_sessions(db_file: str = DB_PATH, table_name: str = TABLE_NAME):
...
def read_sessions(session_id: str = None, user_id: str = None, db_file: str = DB_PATH, table_name: str = TABLE_NAME):
...
def get_last_session_id_by_user(user_id: str, db_file: str = DB_PATH, table_name: str = TABLE_NAME):
